        ...
        return (
            <Col md={12} id="Details">
                ...
                <Row className="r3">
                    <Col>
                        <p>
                            Entering your private key here allows you to view your Zero Classic Address and print your wallet if you wish.
                        </p>
                        <p>
                            <b>Warning: make sure you are on paper.zeroclassic.org!</b>
                        </p>
                        <p>
